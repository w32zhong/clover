...
from ..model.clo_model import CloModel
...
def get_model_answers(
    ...
    model = CloModel.from_pretrained(
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-id", type=str, default="clover-vicuna-7b-fp16")
    parser.add_argument(
        "--bench-name",
        type=str,
        default="mt_bench",
    ...
    args.model_id = args.model_id + "-spe-layer2-lr-temperature-" + str(args.temperature)
    ...
    if args.answer_file:
        ...
        answer_file = f"{args.bench_name}/7b/{args.model_id}.jsonl"
